...
window = loader.load('Assignment-17/calculator.ui')

window.show()
window.setFixedHeight(705)
window.setFixedWidth(495)
...
def change( ):
     ...
     match choice:
          case 1 :     
               ...
               window.textEdit.setStyleSheet("border-radius :25px;background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 rgb(78, 12, 76), stop:1  rgb(255, 39, 251));color: rgb(255, 255, 255);")
               for i in range(1,28):
          ...
          case 2 :     
               ...
               window.textEdit.setStyleSheet("border-radius :25px;background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 rgb(255, 236, 210), stop:0.7 rgb(252, 182, 159));color: rgb(255, 255, 255);")
               for i in range(1,28):
                    button=f"pushButton_{i}"
                    getattr(window,button).setStyleSheet("""
                         QPushButton:hover {
          ...
          case 3 :     
               ...
               window.textEdit.setStyleSheet("border-radius :25px;background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 rgb(17, 153, 142), stop:1 rgb(56, 239, 125));color: rgb(255, 255, 255);")
          ...
          case 4 :     
               ...
               window.textEdit.setStyleSheet("border-radius :25px;background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 rgb(255, 95, 109), stop:1 #FFC371);color: rgb(255, 255, 255);")
               for i in range(1,28):
                    button=f"pushButton_{i}"
                    getattr(window,button).setStyleSheet("""
                         QPushButton:hover {
          ...
          case 5 :     
               ...
               window.textEdit.setStyleSheet("border-radius :25px;background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 #EE9CA7 , stop:1 #FFDDE1);color: rgb(255, 255, 255);")
               for i in range(1,28):
                    button=f"pushButton_{i}"
                    getattr(window,button).setStyleSheet("""
                         QPushButton:hover {
          ...
          case 6 :     
               ...
               window.textEdit.setStyleSheet("border-radius :25px;background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 #662D8C , stop:1 #ED1E79);color: rgb(255, 255, 255);")
               for i in range(1,28):
                    button=f"pushButton_{i}"
                    getattr(window,button).setStyleSheet("""
                         QPushButton:hover {
          ...
          case 7 :     
               ...
               window.textEdit.setStyleSheet("border-radius :25px;background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 #009245 , stop:1 #FCEE21);color: rgb(255, 255, 255);")
               for i in range(1,28):
                    button=f"pushButton_{i}"
                    getattr(window,button).setStyleSheet("""
                         QPushButton:hover {
          ...
          case 8 :     
               ...
               window.textEdit.setStyleSheet("border-radius :25px;background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 #D4145A , stop:1 #FBB03B );color: rgb(255, 255, 255);")
               for i in range(1,28):
                    button=f"pushButton_{i}"
                    getattr(window,button).setStyleSheet("""
                    QPushButton:hover {
...
def result():
     st1 = window.textEdit_2.toPlainText()
     ...
     window.textEdit.setText(str(c))
     window.textEdit_2.setText(st1+st2)




window.pushButton_1.clicked.connect(lambda:text("1"))
window.pushButton_2.clicked.connect(lambda:text("2"))
window.pushButton_3.clicked.connect(lambda:text("3"))
window.pushButton_4.clicked.connect(lambda:text("4"))
window.pushButton_5.clicked.connect(lambda:text("5"))
window.pushButton_6.clicked.connect(lambda:text("6"))
window.pushButton_7.clicked.connect(lambda:text("7"))
window.pushButton_8.clicked.connect(lambda:text("8"))
window.pushButton_9.clicked.connect(lambda:text("9"))
window.pushButton_17.clicked.connect(lambda:text("0"))
window.pushButton_16.clicked.connect(lambda:text("."))
...
window.pushButton_10.clicked.connect(lambda:rev())

window.pushButton_24.clicked.connect(lambda:clear())

window.pushButton_11.clicked.connect(lambda:result())
app.exec()
